...
def generate_date():
    ...
    users = [
        {'username': '2017001', 'password': generate_password_hash('2017001'), 'nickname': '张三', 'gender': 'M', 'role':  'ee'},
        {'username': '2017002', 'password': generate_password_hash('2017002'), 'nickname': '李四', 'gender': 'M', 'role':  'ee'},
        {'username': '2017003', 'password': generate_password_hash('2017003'), 'nickname': '小红', 'gender': 'M', 'role': 'ee'},
        {'username': '2017004', 'password': generate_password_hash('2017004'), 'nickname': '韩梅梅', 'gender': 'M', 'role':'er'},
        {'username': '101', 'password': generate_password_hash('101'), 'nickname': '张老师', 'gender': 'M', 'role': 'er'},
        {'username': '102', 'password': generate_password_hash('102'), 'nickname': '王老师', 'gender': 'M', 'role': 'er'}
    ]
...
def generate_date2():
    ...
    data2 = [
        {'name': '华为', 'address': '云南省昆明市', 'tel': '15087441352', 'biography': 'M'},
        {'name': '三星', 'address': '云南省昆明市', 'tel': '15087441352', 'biography': 'M'},
        {'name': '同方', 'address': '云南省昆明市', 'tel': '15087441352', 'biography': 'M'}
    ]
...
def generate_date4():
    ...
    data4 = [
        {'name': '王五', 'email': '2523892104@qq.com', 'address': '云南省昆明市', 'tel': '15087441352', 'gender': 'F', 'birthday': '2019-6-25'},
        {'name': '张三', 'email': '2523892104@qq.com', 'address': '云南省昆明市', 'tel': '15087441352', 'gender': 'M', 'birthday': '2019-6-25'},
        {'name': '李四', 'email': '2523892104@qq.com', 'address': '云南省昆明市', 'tel': '15087441352', 'gender': 'M', 'birthday': '2019-6-25'}
    ]
